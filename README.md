...
## Titled Information
There is a dummy file **f_model_standard_name_corrections.cfg_TITLED_DUMMY** included in this directory.
This will need to be copied into **cfg_files/TITLED**, renamed **f_model_standard_name_corrections.cfg_TITLED**, and modified.
...
The **f_model_standard_name_corrections.cfg_TITLED** file will contain hand corrections of the standardized firm names in the F model SQL code that is generated by this Python module.
